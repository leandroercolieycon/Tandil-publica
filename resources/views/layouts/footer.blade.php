    ...
    <!-- MASK FORM PLUGIN -->
    <script type="text/javascript" src="{!! asset('js/plugins/maskform/src/jquery.mask.js') !!}"></script>

    <!-- SCRIPTS PARA LOS MAPAS -->
...
{{--     <script type="text/javascript" src="{!! asset('js/cargarsaldo.js') !!}"></script>
    ...
    <script>
        ...
        var base_url = $('meta[name="_base_url"]').attr('content');
