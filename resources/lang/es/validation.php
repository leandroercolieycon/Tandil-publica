...
return [
    ...
    */
    ...
    'custom' => [
        'dni' => [
            'digits_between' => 'Debes ingresar un DNI v&aacute;lido.',
        ],
        'cuit' => [
            'size' => 'Debes ingresar un n&uacute;mero de CUIT v&aacute;lido.'
        ],
        'email' => [
            'same' => 'Los campos de :attribute deben coincidir.'
        ],
        'password_repeat' => [
            'same' => 'Las constraseñas no coinciden.'
        ],
        'patente' => [
            'size' => 'Debes ingresar una patente v&aacute;lida.'
        ],
        'patente_vehiculo_1' => [
            'size' => 'Debes ingresar una patente v&aacute;lida.'
        ],
